...
class Recipe:
    ...
    def create_recipe(cls, data):
        query = "INSERT INTO recipes (name, description, instructions, made_on, under_30, created_on, updated_on, user_id) VALUES (%(name)s, %(description)s, %(instructions)s, %(made_on)s, %(under_30)s, NOW(), NOW(), %(user_id)s);"
